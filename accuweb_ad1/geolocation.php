	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Number of Countries Users Visited</h4>
						<div class="row">
						    <div class="col-md-12">
						        <div class="card">
						            ...
						            <div class="card-body">
						                <table id="locationTable" class="table table-bordered table-striped">
						                    <thead>
						                        <tr>
						                            <th>Country Name</th>
						                            <th>Total Count of Users</th>
						                        </tr>
						                    </thead>
						                    <tbody>
						                        <?php foreach ($getCountryVisitors as $country): ?>
						                            <tr>
						                                <td><?= htmlspecialchars($country['country']) ?></td>
						                                <td><?= $country['total_visitors'] ?></td>
						                            </tr>
						                        <?php endforeach; ?>
						                    </tbody>
						                </table>
