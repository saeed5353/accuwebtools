  ...
  <body class="starter-page-page">
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6">
                  <h5 class="mb-3 text-center">
                    <i class="bi bi-input-cursor-text me-2"></i>XML Input
                  </h5>
                  <div class="editor-container">
                    <textarea id="xml-input" class="form-control" rows="18"
                ...
                <div class="col-md-6">
                  <h5 class="mb-3 text-center">
                    <i class="bi bi-code-slash me-2"></i>Formatted Output
                  </h5>
                  <div class="editor-container" style="display: flex; background: #fff; border: 1px solid #ccc;">
                    <pre id="line-numbers" style="padding: 0.75rem 0.5rem; background: #f0f0f0; text-align: right; user-select: none; margin: 0;"></pre>
                    <pre id="xml-output" style="padding: 0.75rem 0.5rem; background: #fff; flex: 1; white-space: pre-wrap; margin: 0;"></pre>
                  </div>
                  <div class="mt-2" id="validation-status" style="font-weight: bold;"></div>
    ...
    <script>
      ...
      document.getElementById('format-btn').addEventListener('click', function () {
        ...
        const isError = formatted.startsWith("ERROR:");
        document.getElementById('validation-status').textContent = isError ? 'Invalid XML' : 'Valid XML';
        document.getElementById('validation-status').className = isError ? 'text-danger' : 'text-success';

        document.getElementById('error-message').style.display = isError ? 'block' : 'none';
        document.getElementById('error-message').textContent = isError ? formatted : '';
      });
